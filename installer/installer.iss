...
#define MyAppName "Web Bluetooth Host for Firefox"
...
OutputDir=output
OutputBaseFilename=InstallWebBluetoothForFirefoxHost-{#MyAppVersion}
Compression=lzma
...
Root: HKA; Subkey: "SOFTWARE\Mozilla\NativeMessagingHosts\web_bluetooth.server"; ValueType: string; ValueData: "{app}\manifest.json"
